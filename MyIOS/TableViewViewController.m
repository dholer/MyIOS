...
{
    [super viewDidLoad];
    NSMutableArray *array = [[NSMutableArray alloc] initWithObjects:@"cell1", @"cell1",@"cell1",@"cell1",@"cell1",nil];
    self.list = array;   
...
{
    static NSString *CellIdentifier = @"tid";
